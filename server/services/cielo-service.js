...
export class CieloApiError extends Error {
    constructor(statusCode, apiCode, message, correlationId) {
...
class ApiRateLimiter {
    constructor() {
        ...
        this.maxRequests = 30; // 30 requests por minuto
    }
...
export class CieloService {
    ...
    async withRetry(operation, correlationId, context) {
        let lastError;
    ...
    async secureFetch(url, options, correlationId) {
    ...
    detectCardBrand(cardNumber) {
        ...
        if (number.match(/^30[0-5]/) || number.startsWith('36') || number.startsWith('38'))
            return 'Diners';
