...
export class PaymentReceiptService {
     ...
     */
    async generatePaymentReceipt(receiptData, correlationId) {
     ...
     */
    async generatePDF(receiptData, cieloPayment, receiptNumber // ✅ Parâmetro para usar número consistente
    ) {
     ...
     */
    getPaymentMethodFromCielo(paymentType) {
     ...
     */
    async getClientPaymentReceipts(clientEmail) {
        try {
     ...
     */
    async getPaymentReceiptById(receiptId) {
        try {
