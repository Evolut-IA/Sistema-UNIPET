...
export async function executeQueryWithRetry(queryFn, maxRetries = 3, retryDelay = 1000) {
    let lastError = null;
...
export async function executeTransactionWithRetry(transactionFn, maxRetries = 3) {
