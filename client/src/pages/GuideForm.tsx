                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                          {GUIDE_TYPES.flatMap((type, index) => [
                            <SelectItem key={type} value={type} className="py-3 pl-10 pr-4 data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground">
                              {getTypeLabel(type)}
                            </SelectItem>,
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                          {[{value: "open", label: "Aberta"}, {value: "closed", label: "Fechada"}, {value: "cancelled", label: "Cancelada"}].flatMap((status, index, array) => [
                            <SelectItem key={status.value} value={status.value} className="py-3 pl-10 pr-4 data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground">
                              {status.label}
                            </SelectItem>,
